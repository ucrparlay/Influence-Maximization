...
OTHER_GRAPH_DIR="/ssd0/graphs/links"
...
graphs = [
    ...
    ('twitter_sym', 'https://www.dropbox.com/s/vtnfg6e75h0jama/twitter_sym.bin?dl=0', 0.02, OTHER_GRAPH_DIR),
    ('friendster_sym', 'https://www.dropbox.com/s/6xiwui88bacbt6o/friendster_sym.bin?dl=0', 0.02, OTHER_GRAPH_DIR),

    # # Web Graphs
    ('sd_arc_sym', 'https://www.dropbox.com/s/xtkei44fh9v5v73/sd_arc_sym.bin?dl=0', 0.02, OTHER_GRAPH_DIR),
    # # ('ClueWeb_sym', '', 0.02),  # too large

    # # Road Graphs
    ('Germany_sym', 'https://www.dropbox.com/s/42s5gb1gjs36x3z/Germany_sym.bin?dl=0', 0.2, OTHER_GRAPH_DIR),
    ('RoadUSA_sym', 'https://www.dropbox.com/s/a6dhyw9ec0d3hlh/RoadUSA_sym.bin?dl=0', 0.2, OTHER_GRAPH_DIR),

    # KNN Graphs
    ('HT_5_sym', '', 0.2, SMALL_GRAPH_DIR),
    ...
    ('GeoLifeNoScale_5_sym', 'https://www.dropbox.com/s/32cb0d645i2qf30/GeoLifeNoScale_5_sym.bin?dl=0', 0.2, OTHER_GRAPH_DIR),
    ('Cosmo50_5_sym', 'https://www.dropbox.com/s/8oxqut1ff7l73ws/Cosmo50_5_sym.bin?dl=0', 0.2, OTHER_GRAPH_DIR),
]
