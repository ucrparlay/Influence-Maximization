...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status >> $FILE_OUT
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status >> $FILE_OUT
...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status -w 0.2 >> $FILE_OUT
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status -w 0.2 >> $FILE_OUT
...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status  -w 0.1 >> $FILE_OUT
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status -w 0.1 >> $FILE_OUT
