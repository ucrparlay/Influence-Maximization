...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status -local_scc -local_reach  >> $FILE_OUT
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status -local_scc -local_reach  >> $FILE_OUT
...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status -local_scc -local_reach  -w 0.1 >> $FILE_OUT
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status -local_scc -local_reach -w 0.1 >> $FILE_OUT
...
for g in $SMALL_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin -status -local_scc -local_reach -w 0.02 >> $FILE_OUT
    # numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_SMALL/$g.bin $FILE_OUT_DIR/UIC/$g\_2 -w 0.02
...
for g in $LARGE_GRAPH; do
    echo "$g " >> $FILE_OUT
    echo "$g "
    numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin -status -local_scc -local_reach -w 0.02 >> $FILE_OUT
    # numactl -i all /home/lwang323/IM/$COMMOND $BINARY_DATA_PATH_LARGE/$g.bin $FILE_OUT_DIR/UIC/$g\_2 -w 0.02
